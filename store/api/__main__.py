"""
REST API сервис, который позволяет магазинам загружать и обновлять
информацию о товарах, а пользователям - смотреть какие товары были обновлены
за последние сутки
"""
import argparse
import logging
...
from store.utils.argparse import clear_environ, positive_int
from store.utils.pg import DEFAULT_PG_URL


ENV_VAR_PREFIX = 'STORE_'
